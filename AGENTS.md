...
- `src/Dockerfile` — base image (`ghcr.io/bitlank/devcontainer:latest`): Ubuntu 26.04, Node 22, Python + uv, Docker CLI, Claude Code, Codex, Cursor Agent CLI. Lean `dev` user (UID 1000 + sudo); starts as root via entrypoint.
