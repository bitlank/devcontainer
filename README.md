...
Docker-based dev environment with Claude Code, Codex, Cursor Agent, Node.js, Python, and Docker-in-Docker.
...
.dev/
  ...
  state/            # per-user state (claude/cursor/codex config+auth, bash history) — gitignore
